function net = cnnbp(net, y)
    ...
    %%  backprop deltas
    net.od = net.e .* (net.o .* (1 - net.o));   %  output 
    net.fvd = (net.ffW' * net.od);              %  feature vector 
    if strcmp(net.layers{n}.type, 'c')          %  only conv layers has sigm function
        net.fvd = net.fvd .* (net.fv .* (1 - net.fv));%(net.fv .* (1 - net.fv))
    end

    %  reshape feature vector deltas into output map style
    sa = size(net.layers{n}.a{1});%
    fvnum = sa(1) * sa(2);        %fvnum 
    ...
    for l = (n - 1) : -1 : 1
        if strcmp(net.layers{l}.type, 'c')
            ...
            for j = 1 : numel(net.layers{l}.a)
                ...
                %expand
                %(expand( net.layers{l + 1}.d{j}, [net.layers{l + 1}.scale net.layers{l + 1}.scale 1])
